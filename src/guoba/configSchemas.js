...
export function getConfigSchemas() {
  return [
    ...
    {
      field: 'wordcloud.enableMessageCollection',
      label: '启用消息收集',
      bottomHelpMessage: '是否启用消息收集（保存消息到 Redis 用于词云生成）。需要配置 Redis 才能使用',
      component: 'Switch'
    },
    {
      field: 'wordcloud.retentionDays',
      label: '消息保留天数',
      bottomHelpMessage: '消息在 Redis 中保留的天数（默认 7 天）',
      component: 'InputNumber',
      required: true,
      componentProps: {
        min: 1,
        max: 30,
        placeholder: '请输入消息保留天数'
      }
    },
    {
      field: 'wordcloud.maxWords',
      label: '最大显示词汇数',
      bottomHelpMessage: '词云中显示的最大词汇数量',
      component: 'InputNumber',
      required: true,
      componentProps: {
        min: 10,
        max: 500,
        placeholder: '请输入最大显示词汇数'
      }
    },
    {
      field: 'wordcloud.minLength',
      label: '最小词长度',
      bottomHelpMessage: '词汇的最小长度（字符数）',
      component: 'InputNumber',
      required: true,
      componentProps: {
        min: 1,
        max: 10,
        placeholder: '请输入最小词长度'
      }
    },
    {
      field: 'wordcloud.minFrequency',
      label: '最小词频',
      bottomHelpMessage: '词汇出现的最小次数（低于此次数不显示）',
      component: 'InputNumber',
      required: true,
      componentProps: {
        min: 1,
    ...
    {
      field: 'wordcloud.width',
      label: '图片宽度',
      bottomHelpMessage: '词云图片的宽度（像素）',
      component: 'InputNumber',
      required: true,
      componentProps: {
        min: 400,
    ...
    {
      field: 'wordcloud.height',
      label: '图片高度',
      bottomHelpMessage: '词云图片的高度（像素）',
      component: 'InputNumber',
      required: true,
      componentProps: {
        min: 300,
    ...
    {
      field: 'wordcloud.backgroundColor',
      label: '背景颜色',
      bottomHelpMessage: '词云图片的背景颜色（十六进制格式，如 #ffffff）',
      component: 'Input',
      required: true,
      componentProps: {
        placeholder: '请输入背景颜色（如 #ffffff）'
      }
    },
    {
      field: 'wordcloud.render.imgType',
      label: '图片类型',
      bottomHelpMessage: '词云图片的类型：png 或 jpeg',
      component: 'Select',
      required: true,
      componentProps: {
        options: [
    ...
    {
      field: 'wordcloud.render.quality',
      label: '图片质量',
      bottomHelpMessage: '图片质量（1-100，仅对 jpeg 有效）',
      component: 'InputNumber',
      required: true,
      componentProps: {
        min: 1,
