...
class ImageGenerator {
    ...
    async initBrowser() {
        ...
        try {
            ...
            globalConfig.debug('图片生成器浏览器初始化成功')
        } catch (err) {
            this.browserInitPromise = null
            globalConfig.error('图片生成器浏览器初始化失败:', err)
            throw err
        }
    ...
    async closeBrowser() {
        if (this.browser) {
            try {
                ...
                this.browser = null
                this.browserInitPromise = null
                globalConfig.debug('图片生成器浏览器已关闭')
            } catch (err) {
                globalConfig.error('关闭浏览器失败:', err)
            }
        }
    }
     ...
     */
    async generateRankingImage(data, groupId, groupName, title, userInfo = null, options = {}) {
        ...
        try {
            ...
            try {
                ...
                globalConfig.debug('头像加载超时或出错:', err)
            }
