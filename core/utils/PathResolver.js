...
class PathResolver {
    ...
    /**
     * 获取过滤词文件路径
     * @returns {string} 过滤词文件路径
     */
    static getStopwordsPath() {
        return path.join(this.getConfigDir(), 'stopwords.txt')
    }

    /**
     * 获取自定义词典文件路径
     * @returns {string} 自定义词典文件路径
     */
    static getUserDictPath() {
        return path.join(this.getConfigDir(), 'userdict.txt')
    }
     ...
     */
    static getSummaryTemplatesDir() {
        return path.join(this.getResourcesDir(), 'summary-templates')
    }
     ...
     */
    static getSummaryTemplateDir() {
        return this.getSummaryTemplatesDir()
    }
     ...
     */
    static getSummaryTemplatePath() {
        return path.join(this.getSummaryTemplateDir(), 'index.html')
    }

    /**
     * 获取词云模板目录
     * @returns {string} 词云模板目录
     */
    static getWordCloudTemplateDir() {
        return path.join(this.getResourcesDir(), 'wordcloud')
    }

    /**
     * 获取词云模板文件路径
     * @returns {string} 词云模板文件路径
     */
    static getWordCloudTemplatePath() {
        return path.join(this.getWordCloudTemplateDir(), 'index.html')
    }
