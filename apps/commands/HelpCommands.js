...
【数据管理】
#水群清除统计 - 清除当前群的统计数据
#水群同步Redis统计 - 从数据库补当前群 Redis 消息类型统计
#水群总同步Redis统计 - 从数据库补全部群 Redis 消息类型统计
#水群归档僵尸群 - 列出所有僵尸群
#水群确认归档 - 确认归档列出的僵尸群
#水群查看归档列表 - 查看当前归档群组列表
#水群刷新昵称 - 从当前群成员列表刷新统计昵称
#水群总刷新昵称 - 刷新所有当前群统计昵称
#水群清理无效记录 - 清理当前群已退群用户统计
#水群总清理无效记录 - 清理所有当前群已退群用户统计
#水群清理缓存 - 清理运行缓存
